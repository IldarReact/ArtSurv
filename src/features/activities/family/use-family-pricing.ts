...
export function useFamilyPricing() {
  ...
  return useMemo(() => {
    ...
    return {
      datingSearch: getInflatedPrice(FAMILY_PRICES.DATING_SEARCH, economy, FAMILY_PRICE_CATEGORY),
      partnerQuarterlyExpenses: getInflatedPrice(
        FAMILY_PRICES.PARTNER_QUARTERLY_EXPENSES,
        economy,
        FAMILY_PRICE_CATEGORY,
      ),
      petCat: getInflatedPrice(FAMILY_PRICES.PET_CAT, economy, FAMILY_PRICE_CATEGORY),
      petDog: getInflatedPrice(FAMILY_PRICES.PET_DOG, economy, FAMILY_PRICE_CATEGORY),
      petHamster: getInflatedPrice(FAMILY_PRICES.PET_HAMSTER, economy, FAMILY_PRICE_CATEGORY),
