...
interface JobOfferNotificationData {
                  ...
                  return (
                    ...
                    >
                      <div className="flex justify-between items-start gap-3">
                        {isOfferNotif ? (
                          <button
                            className="flex-1 text-left bg-transparent border-none p-0 block w-full cursor-pointer"
                            onClick={() => {
                          ...
                          <div className="flex-1">
                            {notificationContent}
                            {notif.type === 'job_offer' && isJobOfferData(notif.data) && (
