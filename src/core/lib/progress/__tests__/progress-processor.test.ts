...
describe('progress-processor', () => {
  it('should decrement remainingDuration for active items', () => {
    const items: Progressable[] = [
      { id: '1', remainingDuration: 6, title: 'Test 1', totalDuration: 6 },
      { id: '2', remainingDuration: 12, title: 'Test 2', totalDuration: 12 },
    ]
    ...
    expect(result.active[0].remainingDuration).toBe(3)
    expect(result.active[1].remainingDuration).toBe(9)
  })

  it('should move items to completed when remainingDuration reaches 0', () => {
    const items: Progressable[] = [
      { id: '1', remainingDuration: 3, title: 'Test 1', totalDuration: 6 },
      { id: '2', remainingDuration: 9, title: 'Test 2', totalDuration: 12 },
    ]
    ...
    expect(result.active[0].remainingDuration).toBe(6)
  })
  ...
  it('should work with extended interfaces', () => {
    ...
    const items: ExtendedProgress[] = [
      { extra: 'foo', id: '1', remainingDuration: 6, title: 'Test 1', totalDuration: 6 },
    ]
