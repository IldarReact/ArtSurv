...
export const CHARACTER_IMAGES: Record<string, string> = {
  ...
  indebted:
    'https://images.unsplash.com/photo-1542596594-649edbc13630?q=80&w=2580&auto=format&fit=crop',
  investor:
    'https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=2671&auto=format&fit=crop',
  specialist:
    'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=2580&auto=format&fit=crop',
  worker:
    'https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?q=80&w=2670&auto=format&fit=crop',
}

// Modal category images
export const CATEGORY_IMAGES = {
  assets:
    'https://images.unsplash.com/photo-1560518883-ce09059ee971?q=80&w=2573&auto=format&fit=crop',
  debts:
    'https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?q=80&w=2671&auto=format&fit=crop',
  family:
    'https://images.unsplash.com/photo-1511895426328-dc8714191300?q=80&w=2670&auto=format&fit=crop',
  investments:
    'https://images.unsplash.com/photo-1611974765270-ca12586343bb?q=80&w=2574&auto=format&fit=crop',
  savings:
    'https://images.unsplash.com/photo-1565514020176-db79238b6d87?q=80&w=2670&auto=format&fit=crop',
}
...
export const DETAIL_IMAGES = {
  ...
  pet: 'https://images.unsplash.com/photo-1543466835-00a7907e9de1?q=80&w=2574&auto=format&fit=crop',
  spouse:
